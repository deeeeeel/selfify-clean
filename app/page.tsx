...
export default function Home() {
  return (
    <main className="bg-gray-100 min-h-screen pb-24">
      ...
      {/* Quiz Populer */}
      <section className="w-[90%] mx-auto bg-white mt-8 rounded-2xl shadow-md p-4 border-4 border-blue-900">
      ...
      {/* Mood Quotes */}
      <section className="w-[60%] mx-auto mt-8 text-center">
        <h2 className="font-bold text-lg bg-yellow-400 text-blue-900 px-4 py-2 rounded-t-xl">Mood Quotes</h2>
        <MoodQuotes />
        <div className="flex justify-center gap-2 mt-2">
          <button className="bg-yellow-400 text-blue-900 text-xs px-3 py-1 rounded">Share temen lo!</button>
          <button className="bg-yellow-400 text-blue-900 text-xs px-3 py-1 rounded">Download</button>
        </div>
      </section>
