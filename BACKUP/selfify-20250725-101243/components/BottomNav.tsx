  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 bg-white shadow-inner py-2">
      <div className="flex justify-around max-w-[360px] mx-auto text-black">
        <Link href="#" className="text-xl" legacyBehavior><FaArrowLeft /></Link>
        <Link href="/" className="text-xl" legacyBehavior><FaHome /></Link>
        <Link href="/profile" className="text-xl" legacyBehavior><FaUser /></Link>
      </div>
    </nav>
  );
}
