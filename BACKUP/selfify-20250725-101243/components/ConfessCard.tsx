...
export default function ConfessCard({ id, text, love, like, comments, onComment }: ConfessCardProps) {
  return (
    <div className="relative bg-black rounded-3xl shadow-md pt-6 pb-16 px-3 min-h-[180px] overflow-visible">
      {/* Layer Putih */}
      <div className="relative z-10 w-[100%] mx-auto -mt-4 bg-white rounded-2xl shadow-lg px-6 py-8 text-center italic text-black font-['Trebuchet_MS']">
        &quot;{text}&quot;
      </div>
